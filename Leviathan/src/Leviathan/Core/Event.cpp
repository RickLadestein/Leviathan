...
namespace Leviathan::Events {
	...
	std::string RefreshEvent::ToString()
	{
		std::stringstream ss;
	...
	std::string MousePressEvent::ToString()
	{
		std::stringstream ss;
	...
	std::string MouseReleaseEvent::ToString()
	{
		std::stringstream ss;
	...
	std::string KeyTypeEvent::ToString()
	{
		std::stringstream ss;
