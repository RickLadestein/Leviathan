...
public:
	...
	static bool ImportObjFile(std::string folder_id, std::string filename, std::shared_ptr<Attribute> vert, std::shared_ptr<Attribute> norm, std::shared_ptr<Attribute> tex);
};